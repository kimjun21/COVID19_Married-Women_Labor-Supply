...
* reghdfe: 고차원 고정효과 (High-Dimensional Fixed Effects) 를 활용하여 개인·업종·직종·지역 고정효과 [absorb(개인id 업종_더미 직종_더미 지역)] 를 동시에 흡수함
...
* ib2019.year##i.자녀연령: 연도 × 미취학 자녀 유무 상호작용항을 나타냄. 2019년을 기준 연도로 모형 내 연도에 따른 미취학 자녀 유무별 유급노동시간의 변화를 추정함.

...
replace year = 2019 if parm=="2019.year#1.자녀연령"
...
, ///
  ...
  xline(2018, lpattern(solid) lcolor(gs8) lwidth(med)) ///
  title("Placebo Test") ///
...
, ///
  yline(0, lpattern(dot) lwidth(med) lcolor(gs8)) ///
  xline(2017, lpattern(solid) lcolor(gs8) lwidth(med)) ///
  title("Placebo Test") ///
  xtitle("Year") ytitle("Hours of Paid Work") ///
  xscale(range(2015.5 2021.5)) ///
  yscale(range(-25 25)) ///
...
, ///
  yline(0, lpattern(dot) lwidth(med) lcolor(gs8)) ///
  xline(2016, lpattern(solid) lcolor(gs8) lwidth(med)) ///
  title("Placebo Test") ///
  xtitle("Year") ytitle("Hours of Paid Work") ///
  xscale(range(2015.5 2021.5)) ///
  yscale(range(-25 25)) ///
